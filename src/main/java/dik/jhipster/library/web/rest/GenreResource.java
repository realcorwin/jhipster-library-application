...
/**
 * REST controller for managing {@link dik.jhipster.library.domain.Genre}.
 */
@RestController
@RequestMapping("/api")
public class GenreResource {
     ...
     */
    @GetMapping("/genres")
    public ResponseEntity<List<Genre>> getAllGenres(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
